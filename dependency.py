...
from service import TaskService, AuthService
...
def get_auth_service(
    ...
    return AuthService(user_repository, settings=Settings(), google_client=google_client, yandex_client=yandex_client)
