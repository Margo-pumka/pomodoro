...
async def test_redirect_google_url__success(mock_auth_service: AuthService, settings: Settings):
...
async def test_redirect_yandex_url__success(mock_auth_service: AuthService, settings: Settings):
